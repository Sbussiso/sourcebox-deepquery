...
def hello():
    ...
    logger.debug(f"Returning homepage with {len(packs)} codepacks and suggestions enabled: {not disable_prompt_suggestions}")
    return render_template('index.html', suggestions=suggestions, codepacks=packs)
